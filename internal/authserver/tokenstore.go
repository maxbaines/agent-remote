...
// oauth2.TokenStore, sized for just-terminal's actual load (a single OS account,
...
// RemoveByRefresh is a no-op: just-terminal never issues refresh tokens (see
...
// GetByRefresh always returns nil: just-terminal never issues refresh tokens.
